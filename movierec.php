...
$q="SELECT 
	CONCAT(first_name, ' ', last_name) AS name,  subject, body, postedDate, postID From Post, users WHERE categoryID =2 AND Post.user_id=users.user_id order by postedDate DESC  ";			
